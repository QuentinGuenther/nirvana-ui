(window.webpackJsonp = window.webpackJsonp || []).push([
  [2],
  {
      ...
      function (module, __webpack_exports__, __webpack_require__) {
        ...
        function mapToStyles(_ref2) {
          ...
          if (adaptive) {
            ...
            if (
              ...
              placement === enums.m ||
                ((placement === enums.f || placement === enums.k) &&
                  variation === enums.e))
            )
              (sideY = enums.c),
                (y -=
            ...
            if (
              placement === enums.f ||
              ((placement === enums.m || placement === enums.c) &&
                variation === enums.e)
            )
              (sideX = enums.k),
                (x -=
        ...
        function detectOverflow(state, options) {
          ...
          var _options = options,
            ...
            boundary =
              void 0 === _options$boundary ? enums.d : _options$boundary,
                      ...
                      return (
                        (acc[placement] = (function distanceAndSkiddingToXY(
                          ...
                          var basePlacement = getBasePlacement(placement),
                            invertDistance =
                              [enums.f, enums.m].indexOf(basePlacement) >= 0
                                ? -1
                                : 1,
                            _ref =
                  ...
                  if (!state.modifiersData[name]._skip) {
                    for (
                        ...
                        fallbackPlacements =
                          ...
                          !flipVariations
                            ...
                            : (function getExpandedFallbackPlacements(
                                ...
                                if (getBasePlacement(placement) === enums.a)
                                  return [];
                      ...
                      var placement = placements[i],
                        ...
                        isVertical =
                          [enums.m, enums.c].indexOf(_basePlacement) >= 0,
                  ...
                  if (popperOffsets) {
                    ...
                    if (checkAltAxis) {
                      var _offsetModifierState$2,
                        ...
                        isOriginSide =
                          -1 !== [enums.m, enums.f].indexOf(basePlacement),
    ...
    "./node_modules/warning/warning.js": function (
      module,
      exports,
      __webpack_require__
    ) {
